							...
							if(is_array($sliders[$language_id]['elements'])) {
								foreach($sliders[$language_id]['elements'] as $element) {
									if($element['status'] == 1) {
										...
										$description .= '<div class="caption lfl stl '.$element_class.'" data-x="'.$element['x'].'" data-y="'.$element['y'].'" data-speed="'.$element['speed'].'" data-start="'.$element['start'].'" data-easing="'.$element['easing'].'" data-endspeed="'.$element['speed'].'" data-endeasing="'.$element['endeasing'].'">'.$content_element.'</div>';
									}
								}
							}
						}

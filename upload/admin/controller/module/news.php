...
class ControllerModuleNews extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateForm())) {
			...
			$this->redirect($this->url->link('module/news/listing', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	private function getList() {
		...
		$this->data['insert'] = $this->url->link('module/news/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['reset'] = $this->url->link('module/news/reset', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['delete'] = $this->url->link('module/news/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->data['sort_title'] = $this->url->link('module/news/listing', 'token=' . $this->session->data['token'] . '&sort=nd.title' . $url, 'SSL');
		$this->data['sort_date_added'] = $this->url->link('module/news/listing', 'token=' . $this->session->data['token'] . '&sort=n.date_added' . $url, 'SSL');
		$this->data['sort_viewed'] = $this->url->link('module/news/listing', 'token=' . $this->session->data['token'] . '&sort=n.viewed' . $url, 'SSL');
		$this->data['sort_status'] = $this->url->link('module/news/listing', 'token=' . $this->session->data['token'] . '&sort=n.status' . $url, 'SSL');

 ...
 * @version     2.8.12
 */
class Browser extends \Phalcon\Mvc\User\Component
{
    /**
    ...
    protected static $phoneDevices = array(
        'iPhone'        => '\biPhone\b|\biPod\b|iPhone', // |\biTunes
        ...
        'Asus'          => 'Asus.*Galaxy|PadFone.*Mobile|ASUS ',
     ...
     * @var array
     */
    protected static $mobileOperatingSystems = array(
        'AndroidOS'         => 'Android',
    ...
    /**
     * List of pc Operating Systems.
     *
     * @var array
     */
    protected static $pcOperatingSystems = array(
        'LinuxOS'           => 'Linux',
     ...
     * @var array
     */
    protected static $browserProperties = array(
        // Browser
    ...
    /**
     * Method gets the pc detection rules + utilities.
     * The reason this is separate is because utilities rules
     * don't necessary imply pc. This method is used inside
     * the new $detect->is('stuff') method.
     *
     * @deprecated since version 2.6.9
     *
     * @return array All the rules + extended.
     */
    public function getPcDetectionRulesExtended()
    {
        static $rules;
        if (!$rules) {
            // Merge all rules together.
            $rules = array_merge(
                self::$pcOperatingSystems
            );
        }
        return $rules;
    }
    ...
    public function getRules()
    {
        ...
        } elseif ($this->detectionType == self::DETECTION_TYPE_PC) {
            return self::getPcDetectionRulesExtended();
        } else {
     ...
     */
    public static function getMobileOperatingSystems()
    {
        return self::$mobileOperatingSystems;
    }
    /**
     * Retrieve the list of pc operating systems.
     *
     * @return array The list of pc operating systems.
     */
    public static function getPcOperatingSystems()
    {
        return self::$pcOperatingSystems;
    }
    /**
    ...
    /**
     * Get the browser properties array.
     *
     * @return array
     */
    public static function getBrowserProperties()
    {
        return self::$browserProperties;
    }
    /**
     * Get the os properties array.
     *
     * @return array
     */
    public static function getOsProperties()
    {
     ...
     */
    public function version($propertyName, $properties, $type = self::VERSION_TYPE_STRING)
    {

...
class Pagination extends \Phalcon\Mvc\User\Component {
    ...
    public function itemPerPage($page) {
        $numberItems = array();
        $start  = $this->systemConfig['Frontend_Start_Number_Of_Item_Per_Page'];
        $end    = $this->systemConfig['Frontend_End_Number_Of_Item_Per_Page'];
        $step   = $this->systemConfig['Frontend_Step_Number_Of_Item_Per_Page'];
        ...
        $itemPerPage = $request->getQuery("itemPerPage", null, $this->systemConfig['Frontend_Number_Of_Item_Per_Page']);

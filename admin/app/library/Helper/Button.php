...
class Button extends \Phalcon\Mvc\User\Component {
  ...
  public function newRow($params = array()) {
    ...
    $name   = $this->label->button('New-Name', false);
  ...
  public function editRow($id) {
    ...
    $name   = $this->label->button('Edit-Name', false);
  ...
  public function deleteRow($id) {
    ...
    $name   = $this->label->button('Delete-Name', false);
  ...
  public function backToList($params = array()) {
    ...
    $name   = $this->label->button('Back-To-List-Name', false);
  ...
  public function saveRow() {
    ...
    $name   = $this->label->button('Save-Name', false);
  ...
  public function submitForm() {
    $action = '/' . $this->view->getControllerName() . '/' . $this->view->getActionName();
    $name   = $this->label->button('Submit-Name', false);
  ...
  public function resetForm() {
    $action = '/' . $this->view->getControllerName() . '/' . $this->view->getActionName();
    $name   = $this->label->button('Reset-Name', false);
  ...
  public function approved($id, $status){    
    ...
    $status = ($status) ? $this->label->button('Approved', false) : $this->label->button('Unapproved', false);
  ...
  public function disabled($id, $value, $status = "is_disabled") {
    ...
    $title  = ($value) ? $this->label->button('Disabled', false) : $this->label->button('Active', false);
  ...
  public function google($id, $status){
    ...
    $status = ($status) ? $this->label->button('Google', false) : $this->label->button('Not-Google', false);
  ...
  public function regenerate($action = 'regenerate') {
    $name    = $this->label->button('Regenerate-Name', false);
  ...
  public function publicWordlist($id, $status){
    ...
    $status = ($status) ? $this->label->button('Public', false) : $this->label->button('Unpublic', false);
  ...
  public function featured($id, $status){
    ...
    $status = ($status) ? $this->label->button('Featured', false) : $this->label->button('Unfeatured', false);
